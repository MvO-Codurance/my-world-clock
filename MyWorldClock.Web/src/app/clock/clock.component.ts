...
export class ClockComponent implements AfterViewInit {
  ...
  @ViewChild('clockHourHand') clockHourHand: ElementRef<SVGLineElement> | undefined;
  @ViewChild('clockMinuteHand') clockMinuteHand: ElementRef<SVGLineElement> | undefined;
  @ViewChild('clockSecondHand') clockSecondHand: ElementRef<SVGElement> | undefined;
  @ViewChild('clockDatetimeString') clockDatetimeString: ElementRef<HTMLDivElement> | undefined;
